...
const audioUrl =
	"https://anonyvent.s3.us-east-2.amazonaws.com/mp3file-1719145256057.mp3";
...
async function gptChecker() {
	...
	const rules =
		"If the following transcription mentions sex, not including fuck in an upset manner, murdering someone, or mentions gravely hurting someone return true, if not then return false: ";
